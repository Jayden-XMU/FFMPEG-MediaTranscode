...
About how to use it:
    ...
    1： we can Create a build file inside current in the current path to compile this project by using: 
	         camke .. && make
    ...
    2： we can also create a build-arm64 file inside current in the current path to compile this project by using: 
             camke .. && make -DENABLE_ARM_CROSS_COMPILE=ON 
		to get the target zetMediaServer file which can be used in Arm platform
...
About the timing diagram of the entire project:

<img width="7524" height="15916" alt="image" src="https://github.com/user-attachments/assets/c0d5c889-dcea-43e0-92ca-e83bcb84ceb3" />
